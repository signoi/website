...
function signoi_theme_scripts() {
	wp_enqueue_style( 'signoi-theme-style', get_stylesheet_uri() );

	wp_enqueue_style( 'signoi-theme-sass', get_template_directory_uri() . '/sass/style.css', array(), '20151215', true );
